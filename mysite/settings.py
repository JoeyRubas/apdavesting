...
SECRET_KEY = 'django-insecure-ed9xr)s%gli+(5u=)u5#1o(g!5!lj=ank8%@(ceu&*%k1aoo(x'
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'apdavesting-production.up.railway.app'
]
...
CSRF_TRUSTED_ORIGINS = [
    "https://apdavesting-production.up.railway.app",
]
